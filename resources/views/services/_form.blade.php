<div class="card">
    ...
    <div class="row" id="code">
        <div class="col-md-3 mb-3">
            ...
            <input name="code" class="form-control"
                   value="{{ old('code', $service->code ?? '') }}" placeholder="enter code">
        </div>
    </div>
    ...
    <div class="row" id="description">
        <div class="col-md-3 mb-3">
            ...
            <input name="description" class="form-control"
                   value="{{ old('description', $service->description ?? '') }}" placeholder="Enter description">
        </div>
    </div>
    ...
    <a class="btn btn-link" href="{{ route('services.index') }}">Cancel</a>
</div>